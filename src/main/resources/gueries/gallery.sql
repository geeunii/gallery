...
insert into members(name, login_id, login_pw, login_pw_salt)
values ('알파', 'alpha@example.com', '1111', '1111'),
       ('베타', 'beta@example.com', '1111', '1111'),
       ('감마', 'gamma@example.com', '1111', '1111');
